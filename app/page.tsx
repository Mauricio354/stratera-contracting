    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-primary">
        ...
        <div
          ...
          style={{ backgroundImage: "url(/images/optimized/hero.webp)" }}
        >
        ...
        <div className="container grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="relative">
            <div className="relative w-full aspect-[2/3] rounded-2xl overflow-hidden">
              <Image src="/images/patrick-newheadshot.jpg" alt="Patrick Ballard - Owner of Statera Contracting" fill className="object-cover" sizes="(max-width:1024px) 100vw, 50vw" />
            </div>
