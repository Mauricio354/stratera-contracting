...
const services: Service[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/images/optimized/SPDD-2856-2-compact.webp", alt: "Commercial space renovation Calgary", label: "Commercial Space — Full Renovation" },
      ...
      { src: "/images/optimized/TheStill_Mar8_MichaelTrudeauPhotography_-2-compact.webp", alt: "Downtown restaurant interior design Calgary", label: "Downtown Restaurant — Interior Design" },
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/images/optimized/A-3-compact.webp", alt: "Home addition in progress Calgary — exterior build", label: "In Progress — Exterior Build" },
      { src: "/images/optimized/A-5-compact.webp", alt: "Home addition in progress Calgary — construction phase", label: "In Progress — Construction Phase" },
      { src: "/images/optimized/A-6-compact.webp", alt: "Home addition in progress Calgary — framing and interior", label: "In Progress — Framing & Interior" },
      { src: "/images/optimized/B-1-compact.webp", alt: "Home addition Calgary — before photo", label: "Before" },
      { src: "/images/optimized/B-2-compact.webp", alt: "Home addition Calgary — before photo", label: "Before" },
